...
#SBATCH -o slurm_outfiles/normal_tiniersvgd_action_chain.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/normal_tiniersvgd_action_chain.err # name of error file for this submission script
