...
#SBATCH -o slurm_outfiles/retrial.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/retrial.err # name of error file for this submission script
