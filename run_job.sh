...
#SBATCH -o slurm_outfiles/harmonic_convergence.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/harmonic_convergence.err # name of error file for this submission script
