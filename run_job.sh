...
#SBATCH -o slurm_outfiles/trial_genparams.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/trial_genparams.err # name of error file for this submission script
