...
#SBATCH -o slurm_outfiles/svgd_converge.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/svgd_converge.err # name of error file for this submission script
